...
import com.example.wizzar.presentation.components.CurrentWeatherSection
import com.example.wizzar.presentation.components.DailyForecastSection
import com.example.wizzar.presentation.components.HeaderSection
import com.example.wizzar.presentation.components.HourlyForecastSection
import com.example.wizzar.presentation.components.WeatherDetailsGrid
...
fun HomeScreen(
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted) {
            // We only force refresh if they JUST granted the permission for the first time
    ...
    // 2. Only launch the request if we DO NOT have permission
    LaunchedEffect(Unit) {
